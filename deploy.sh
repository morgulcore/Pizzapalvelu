...
rsync -z -r $DIR/app $DIR/assets $DIR/config $DIR/lib $DIR/sql $DIR/vendor $DIR/index.php $DIR/composer.json $DIR/images $USERNAME@users.cs.helsinki.fi:htdocs/$PROJECT_FOLDER
